                        ...
                        <div class="row col-lg-12">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-10 col-xs-12  justify-content-center"> 
                               ...
                               <div class="form-group">
                                <label class="col-form-label" for="privacy_policy">Privacy Policy <span class="text-danger">*</span>
                                </label>
                                <textarea class="summernote" id="privacy_policy" name="privacy_policy"></textarea>
                                <div id="privacy_policy-error" class="invalid-feedback animated fadeInDown" style="display: none;"></div>
                               </div>
                            </div>
                        </div>
            ...
            success: function (res) {
                if(res.status == 'failed'){
                    ...
                    if (res.errors.privacy_policy) {
                        $('#privacy_policy-error').show().text(res.errors.privacy_policy);
                    } else {
