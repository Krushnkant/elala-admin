                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="action-section row">
                            ...
                            <div class="custom-tab-1 col-lg-4 mt-3">
                        ...
                        <div class="tab-pane fade show active table-responsive" id="all_team_tab">
                            <table id="all_teams" class="table zero-configuration customNewtable" style="width:100%">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Image</th>
...
<script type="text/javascript">
    ...
    $('body').on('click', '#AddTeamBtn', function (e) {
        $("#TeamModel").find('.modal-title').html("Add Team Member");
    });
