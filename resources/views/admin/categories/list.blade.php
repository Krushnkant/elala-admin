                    ...
                    <div class="card-body">
                        ...
                        <div class="action-section">
                            ...
                            @if(getUSerRole()==1 || (getUSerRole()!=1 && is_write($page_id)) )
                                <button type="button" class="btn btn-primary" id="AddCategoryBtn"><i class="fa fa-plus" aria-hidden="true"></i></button>
                            @endif
                            </div>
                        </div>
...
$('body').on('click', '#addCategoryAttributeBtn', function (e) {
    // e.preventDefault();
    var category_id = $(this).attr('data-id');
    var url = "{{ url('admin/addcategoryattribute') }}" + "/" + category_id;
    window.open(url,"_blank");
});
