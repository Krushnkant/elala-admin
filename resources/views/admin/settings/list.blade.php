                            ...
                            <thead>
                                    <tr>
                                        ...
                                        <th colspan="2" class="text-right">
                                            <button id="editSettingBtn" class="btn btn-outline-white btn-sm" data-toggle="modal" data-target="#SettingModel">
    ...
    <div class="modal fade" id="SettingModel">
        <div class="modal-dialog modal-dialog-centered mw-100 w-50" role="document">
            <div class="modal-content">
                <form class="form-valide" action="" id="SettingForm" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="saveSettingBtn">Save <i class="fa fa-circle-o-notch fa-spin loadericonfa" style="display:none;"></i></button>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    $('#SettingModel').on('shown.bs.modal', function (e) {
        $("#prefix_invoice_no").focus();
    });

    $('#SettingModel').on('hidden.bs.modal', function () {
    ...
    $('body').on('click', '#editSettingBtn', function () {
    ...
    $('body').on('click', '#saveSettingBtn', function () {
        ...
        $('#saveSettingBtn').find('.loadericonfa').show();
        var formData = new FormData($("#SettingForm")[0]);

        $.ajax({
            type: 'POST',
            url: "{{ url('admin/updateSetting') }}",
            data: formData,
            processData: false,
            contentType: false,
            success: function (res) {
                if(res.status == 'failed'){
                    ...
                    $('#saveSettingBtn').find('.loadericonfa').hide();
